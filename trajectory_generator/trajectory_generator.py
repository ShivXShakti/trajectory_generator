...
class TrajectoryGenerator(Node):
    ...
    output: x, x_dot
    """ 
    def __init__(self, T_init = None, T_final=None, traj_time=10, sampling_frequency=100, smoothed_traj = True,traj_type="straight"):
        ...
        self.smoothed_traj = smoothed_traj
    ...
    def trajectory_smooth(self):
        ...
        if self.smoothed_traj == True:
            s = 10*(self.time_counter/self.traj_time)**3-15*(self.time_counter/self.traj_time)**4+6*(self.time_counter/self.traj_time)**5
        else:
